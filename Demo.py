...
print("\nType 'exit' anytime to terminate the program.")
...
while True:
    ...
    user_input = input(
        "\nEnter movie, actor, director, industry or genre: "
    ).strip()
    ...
    if count_input == "":
        ...
        try:
            ...
            print(
                "Invalid number. Using default value 15."
            )
